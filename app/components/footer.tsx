...
export default function Footer() {
  return (
    <footer className="bg-zinc-900 text-gray-300 mt-12">
      <div className="max-w-7xl mx-auto px-6 py-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        {/* --- Cột 1 --- */}
        <div>
          <h3 className="text-white font-semibold text-lg mb-4">Về chúng tôi</h3>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li><Link href="/khoa-hoc/lap-trinh-web" className="hover:underline">Lập trình web</Link></li>
            <li><Link href="/khoa-hoc/phan-tich-du-lieu" className="hover:underline">Phân tích dữ liệu</Link></li>
            <li><Link href="/khoa-hoc/kinh-doanh-so" className="hover:underline">Kinh doanh số</Link></li>
          </ul>
        </div>
