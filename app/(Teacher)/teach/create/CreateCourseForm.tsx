// File: app/(Teacher)/teach/create/CreateCourseForm.tsx
"use client";
...
// 1. Import hook tạo khóa học (Giả định path chính xác)
...
export default function CreateCourseForm() {
    ...
    // State 2: Nội dung (Sections/Lectures)
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        const submissionData = {
            ...
            sections: sections.map(s => ({
                title: s.title,
                // Lấy lectures, đảm bảo duration là NUMBER
